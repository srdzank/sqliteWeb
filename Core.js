...
[ "_openDatabase", "_memory", "___indirect_function_table", "_jsHaveAsyncify", "_jsHaveJspi", "___asyncjs__qt_jspi_suspend_js", "_qt_jspi_resume_js", "_qt_jspi_can_resume_js", "_init_jspi_support_js", "_qt_asyncify_suspend_js", "_qt_asyncify_resume_js", "_main", "onRuntimeInitialized" ].forEach(prop => {
...
var ASM_CONSTS = {
 9733580: () => {
  if (!FS.analyzePath("/database").exists) {
   FS.mkdir("/database");
   FS.mount(MEMFS, {}, "/database");
  }
 }
};
...
var Asyncify = {
 instrumentWasmImports(imports) {
  var importPattern = /^(qt_asyncify_suspend_js|qt_asyncify_resume_js|invoke_.*|__asyncjs__.*)$/;
...
var _emscripten_idb_delete = function(db, id, perror) {
 db >>>= 0;
 id >>>= 0;
 perror >>>= 0;
 return Asyncify.handleSleep(wakeUp => {
  IDBStore.deleteFile(UTF8ToString(db), UTF8ToString(id), error => {
   HEAP32[((perror) >>> 2) >>> 0] = !!error;
   wakeUp();
  });
 });
};
...
var _emscripten_idb_exists = function(db, id, pexists, perror) {
 db >>>= 0;
 id >>>= 0;
 pexists >>>= 0;
 perror >>>= 0;
...
var _emscripten_idb_load = function(db, id, pbuffer, pnum, perror) {
 db >>>= 0;
 id >>>= 0;
 pbuffer >>>= 0;
 pnum >>>= 0;
 ...
 return Asyncify.handleSleep(wakeUp => {
  IDBStore.getFile(UTF8ToString(db), UTF8ToString(id), (error, byteArray) => {
   ...
   HEAPU32[((pbuffer) >>> 2) >>> 0] = buffer;
   HEAP32[((pnum) >>> 2) >>> 0] = byteArray.length;
   HEAP32[((perror) >>> 2) >>> 0] = 0;
   wakeUp();
  });
 });
...
var _emscripten_idb_store = function(db, id, ptr, num, perror) {
 db >>>= 0;
 id >>>= 0;
 ptr >>>= 0;
 perror >>>= 0;
...
var _emscripten_request_animation_frame = function(cb, userData) {
 cb >>>= 0;
 userData >>>= 0;
 return requestAnimationFrame(timeStamp => ((a1, a2) => dynCall_idi(cb, a1, a2))(timeStamp, userData));
};
...
var _emscripten_set_timeout = function(cb, msecs, userData) {
 cb >>>= 0;
 userData >>>= 0;
 return safeSetTimeout(() => (a1 => dynCall_vi(cb, a1))(userData), msecs);
};
...
var _openDatabase = Module["_openDatabase"] = createExportWrapper("openDatabase");
...
var dynCall_vdiiiiiii = Module["dynCall_vdiiiiiii"] = createExportWrapper("dynCall_vdiiiiiii");
...
var dynCall_viiiiiiiiiddd = Module["dynCall_viiiiiiiiiddd"] = createExportWrapper("dynCall_viiiiiiiiiddd");
...
var ___start_em_js = Module["___start_em_js"] = 9733682;

var ___stop_em_js = Module["___stop_em_js"] = 9734772;
...
function invoke_vdiiiiiii(index, a1, a2, a3, a4, a5, a6, a7, a8) {
 var sp = stackSave();
 try {
  dynCall_vdiiiiiii(index, a1, a2, a3, a4, a5, a6, a7, a8);
 } catch (e) {
  stackRestore(sp);
  if (e !== e + 0) throw e;
  _setThrew(1, 0);
